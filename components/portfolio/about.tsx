...
const About = () => {
  ...
  { value: "280+", label: "Problems Solved", suffix: "" },
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                   Software Developer with hands-on experience designing and deploying scalable full-stack web applications
using Node.js, MySQL, and React.js. Proficient in architecting clean RESTful APIs and type-safe user interfaces with TypeScript and Tailwind CSS. Strong foundation in Data Structures & Algorithms and Computer
Science fundamentals, with strong analytical and problem-solving skills.
                  </p>
                </div>
              </div>
            ...
            <div className="pl-15">
  <a
    href="/public/Payal_Jaiswal_Resume.pdf"
    target="_blank"
