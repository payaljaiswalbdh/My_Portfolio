            ...
            >
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-muted-foreground">
                  ...
                  <span>
                    Solved <span className="text-primary font-semibold">4000+ problems</span>  across LeetCode and HackerRank, demonstrating strong Data Structures
                ...
                <li className="flex items-start gap-3 text-muted-foreground">
                  <span className="w-2 h-2 mt-2 bg-primary rounded-full shrink-0" />
                  <span>
                    Earned  <span className="text-primary font-semibold">Salesforce Trailhead badges</span> in Artificial Intelligence Fundamentals and Generative AI Basics
                  </span>
                </li>
              </ul>
            </motion.div>
