          ...
          >
            ...
            <motion.p
              ...
              className="text-muted-foreground text-lg leading-relaxed mb-8 max-w-lg">
               Computer Science Graduate with a strong foundation in Java and DSA, validated by 250+ LeetCode solutions. Hands-on experience engineering scalable full-stack applications and optimizing complex algorithms. Seeking to leverage robust
              problem-solving skills to contribute clean, production-ready code to an innovative development team.
